...
const Perks = ({ selected, onChange }) => {
  ...
  return (
    <>
      <label className="flex gap-2 border p-4 border-gray-400  rounded-2xl items-center">
        <input
      ...
      <label className="flex gap-2 border p-4 border-gray-400 rounded-2xl items-center">
        ...
        <span className="font-semibold">Private enterence</span>
      </label>
    </>
  );
};
